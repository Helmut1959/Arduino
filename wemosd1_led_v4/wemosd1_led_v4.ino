/*--------------------------------------------------
  ...
  Dauertest über mehr als 24 h lief stabil
  -----------------------------------------------*/
...
void loop()
{
  ...
  {
    ulReqcount++;
    sResponse  = "<html><head><title>LED-Steuerung mit WeMos D1 </title></head><body>";
    sResponse += "<font color=\"#000000\"><body bgcolor=\"#11CC00\">";
    sResponse += "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=yes\">";
    sResponse += "<h1> &nbsp  &nbsp LED-Steuerung mit WeMos D1 </h1>";
    sResponse += "  <BR>";
    sResponse += "<FONT SIZE=+1>";
    sResponse += "<p>Gr&uumlne LED &nbsp  <a href=\"?pin=FUNCTION1ON\"><button>einschalten</button></a>&nbsp;<a href=\"?pin=FUNCTION1OFF\"><button>ausschalten</button></a></p>";
    sResponse += "<p>Gelbe LED &nbsp  <a href=\"?pin=FUNCTION2ON\"><button>einschalten</button></a>&nbsp;<a href=\"?pin=FUNCTION2OFF\"><button>ausschalten</button></a></p>";
