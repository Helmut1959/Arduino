...
int watch() {
  ...
  Fdistance= Fdistance / 5.8;       
  return (int)Fdistance;
}  

void watchsurrounding(){     
float alpha, alpha_opt1, alpha_opt2;
int x1, distance1 , distance2;
 ...
 for (int i1 = 1;i1<=14; i1 ++) {
  ...
  Serial.println("A / D: " + String (alpha_opt,1) + " " + String (distance,1)); 
  delay(100);
}
